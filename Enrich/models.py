...
class Organization_Staff(models.Model):
    ...
    def __str__(self):
        return self.organization_staff_id + ', ' + self.email + ', ' + self.name + ', ' + self.title + ', ' + self.organization_id
...
class Reviews(models.Model):
    ...
    def __str__(self):
        return self.review_id + ', ' + self.review_text + ', ' + self.rating + ', ' + self.date + ', ' + self.user_id
